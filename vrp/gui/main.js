window.addEventListener("load", function () {
	...
	window.addEventListener("message", function (evt) { //lua actions
		...
		if (data.act == "cfg") {
			...
			document.getElementById("ogrp_mainMenu").style.fontFamily = data.font;
			document.getElementById("ogrp_menuHeader").style.fontFamily = data.font;
			document.getElementById("ogrp_menuChoices").style.fontFamily = data.font;
			document.getElementById("ogrp_menuDescriptionContent").style.fontFamily = data.font;
			document.getElementById("ogrp_mainMenu").style.backgroundImage = data.wallpaper;
		}
